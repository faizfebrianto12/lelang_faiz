    ...
    ?>
                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_user']; ?>">
                    ...
                    <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_user" value="<?php echo $row['id_user']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Nama Lengkap</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="nama_lengkap" value="<?php echo $row['nama_lengkap']; ?>">
                            </td>
                        </tr>           
                        <tr>
                            <td>Username</td>
