...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="pagetitle">
  <h1> Petugas</h1><br>
  <h5><a href="petugas/insert.php">Tambah</a><h5>
    ...
    while($result =mysqli_fetch_array($query)){
        ...
        <tr bgcolor="transparent" class="text1">
            ...
            <td>
            <button class="button"><a href="petugas/proses-delete.php?id=<?php echo $result['id_petugas']?>">Delete</a></button>
            <button class="button"><a href="petugas/update.php?id=<?php echo $result['id_petugas']?>">Update</a></button>
            <button class="button"><a href="petugas/cetak.php?id=<?php echo $result['id_petugas']?>">Cetak</a></button>
    </td>
