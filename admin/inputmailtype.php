 ...
 <div class="content">
        <section class="section"></br></br>
            ...
            <div class="section-content">
                <h4>Input Data Mail Type</h4></br>
    <center>
        <div class="add">
            <div class="container">
                <div class="box-kamar">
                <form class="" action="./mailtypeproses.php" method="post">
                    <table border="1">
                        <tr>
                            <td>Id Type</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="id_type">
                            </td>
                        </tr>
                        <tr>
                            <td>Type</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="type">
                            </td>
                        </tr>
                        <tr>
