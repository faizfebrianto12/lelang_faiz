 ...
 <div class="content">
    ...
    <center>
        <div class="add">
            <div class="container">
                <div class="box-kamar">
                <form class="" action="./userproses.php" method="post">
                    <table border="1">
                        <tr>
                            <td>Id User</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="id_user">
                            </td>
                        </tr>
                        <tr>
                            <td>Username</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="username">
                            </td>
                        </tr>
                        <tr>
                            <td>Password</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="password">
                            </td>
                        </tr>
                        <tr>
                            <td>Full Name</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="fullname">
                            </td>
                        </tr>
                        <tr>
                            <td>Level</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="level">
                            </td>
                        </tr>
                        <tr>
