...
<body id="page-top">
 ...
 <h5>Update Data</h5>
  ...
  <h5><a href="../petugas.php">Kembali</a><h5>
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($koneksi, "SELECT * FROM tb_petugas WHERE id_petugas = '$id'");
    ...
    ?>
                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_petugas']; ?>">
                    <table border="1" cellpadding="4">
                    <tr>
                            <td>Id Petugas</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_petugas" value="<?php echo $row['id_petugas']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Nama Petugas</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="nama_petugas" value="<?php echo $row['nama_petugas']; ?>">
                            </td>
                        </tr>           
                        <tr>
                            <td>Username</td>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="password" value="<?php echo $row['password']; ?>">
                            </td>
                        </tr>   
                        <tr>
                            <td>Id Level</td>
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_level" value="<?php echo $row['id_level']; ?>">

<?php
require __DIR__. './koneksi.php';
$sql = mysqli_query($koneksi, "SELECT * FROM tb_level");
while ($row = mysqli_fetch_assoc($sql)) {
?>
<option><?php echo $row['id_level'] ?></option>
<?php
}
?>
</select>
