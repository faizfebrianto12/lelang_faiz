...
<body id="page-top">
 ...
 <h5>Update Data</h5>
  ...
  <h5><a href="../level.php">Kembali</a><h5>
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($koneksi, "SELECT * FROM tb_level WHERE id_level = '$id'");
    ...
    ?>
                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_level']; ?>">
                    <table border="1" cellpadding="4">
                    <tr>
                            <td>Id Level</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_level" value="<?php echo $row['id_level']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Level</td>
                            <td align="center">:</td>
                            <td>
                            <select name="level" id="" class="j" value="<?php echo $row['level']; ?>">
                            <option>Pilih Status</option>
                            <option value="administrator" class="j">Administrator</option>
                            <option value="petugas" class="j">Petugas</option>
                            </select>
                            </td>
                        </tr>
                        <tr>
