 ...
 <div class="content">
    ...
    <center>
        <div class="add">
            <div class="container">
                <div class="box-kamar">
                <form class="" action="./mailproses.php" method="post">
                    <table border="1">
                        <tr>
                            <td>Id Mail</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="id_mail">
                            </td>
                        </tr>
                        <tr>
                            <td>Incoming At</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="incoming_at">
                            </td>
                        </tr>
                        <tr>
                            <td>Mail Code</td>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="date" class="kamar-input" name="mail_date">
                            </td>
                        </tr>
                        <tr>
                            <td>Mail From</td>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="mail_to">
                            </td>
                        </tr>
                        <tr>
                            <td>Mail Subject</td>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="order-input" name="mail_typeid">
                                <?php
                                require __DIR__. './koneksi.php';
                                $sql = mysqli_query($koneksi, "SELECT * FROM mail_type");
                                while ($row = mysqli_fetch_assoc($sql)) {
                                ?>
                                <option><?php echo $row['id_type'] ?></option>
                                <?php
                                }
                                ?>
                                </select>
