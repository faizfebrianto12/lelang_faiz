...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cuser.php">User</a>
                    </div>
                </div>
            </li>
 ...
 <div class="content">
        <section class="section"></br></br>
            ...
            <p class="insert"><i class="fa-solid fa-chevron-left"></i><a href="index.php">Kembali</a></p>
            <div class="section-content">
                <h4>Input Disposition</h4>
    <center>
        <div class="add">
            <div class="container">
                <div class="box-kamar">
                <form class="" action="./dispositionproses.php" method="post">
                    <table border="1">
                        <tr>
                            <td>Id Disposition</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="id_disposition">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="disposition_at">
                            </td>
                        </tr>
                        <tr>
                            <td>Reply At</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="reply_at">
                            </td>
                        </tr>
                        <tr>
                            <td>Desciption</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="desciption">
                            </td>
                        </tr>
                        <tr>
                            <td>Notification</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="notification">
                            </td>
                        </tr>
                        <tr>
                            <td>Mail Id</td>
                            <td align="center">:</td>
                            <td>
                            <select class="order-input" name="mailid">
                                <?php
                                require __DIR__. './koneksi.php';
                                $sql = mysqli_query($koneksi, "SELECT * FROM mail");
                                while ($row = mysqli_fetch_assoc($sql)) {
                                ?>
                                <option><?php echo $row['id_mail'] ?></option>
                                <?php
                                }
                                ?>
                                </select>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="order-input" name="userid">
                                <?php
                                require __DIR__. './koneksi.php';
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="kamar-input" name="status">
                            </td>
                        </tr>
                        <tr>
