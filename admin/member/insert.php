                ...
                <form class="" action="./insert_proses.php" method="post">
                    <table border="1" cellpadding="4">
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_paket">
                            </td>
                        </tr>
                        <tr>
                            <td>Id Outlet</td>
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="nama_paket">
                            </td>
                        </tr>
                        <tr>
                            <td>Harga</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="harga">
                            </td>
                        </tr>
                        <tr>
