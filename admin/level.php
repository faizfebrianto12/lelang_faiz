...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="pagetitle">
  <h1> Level</h1><br>
  <h5><a href="level/insert.php">Tambah</a><h5>
    ...
    while($result =mysqli_fetch_array($query)){
        ...
        <tr bgcolor="transparent" class="text1">
            ...
            <td>
            <button class="button"><a href="level/proses-delete.php?id=<?php echo $result['id_level']?>">Delete</a></button>
            <button class="button"><a href="level/update.php?id=<?php echo $result['id_level']?>">Update</a></button>
            <button class="button"><a href="level/cetak.php?id=<?php echo $result['id_level']?>">Cetak</a></button>
    </td>
