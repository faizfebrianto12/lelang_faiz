                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_lelang']; ?>">
                    <table border="1" cellpadding="4">
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_lelang" value="<?php echo $row['id_lelang']; ?>" readonly>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="date" class="form-input" name="tgl_lelang" value="<?php echo $row['tgl_lelang']; ?>" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>Harga Akhir</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="harga_akhir" value="<?php echo $row['harga_akhir']; ?>" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>Id Barang</td>
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_barang" value="<?php echo $row['id_barang']; ?>" readonly>
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_user" value="<?php echo $row['id_user']; ?>" readonly>
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_petugas" value="<?php echo $row['id_petugas']; ?>" readonly>
