                ...
                <form class="" action="./insert_proses.php" method="post">
                    <table border="1" cellpadding="4">
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_lelang">
                            </td>
                        </tr>
                        <tr>
                            <td>Id Barang</td>
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="date" class="form-input" name="tgl_lelang">
                            </td>
                        </tr>
                        <tr>
                            <td>Harga Akhir</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="harga_akhir">
                            </td>
                        </tr>
                        <tr>
                            <td>Id User</td>
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_petugas">
