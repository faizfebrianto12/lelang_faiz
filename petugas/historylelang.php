...
<body id="page-top">
  ...
  <h5><a href="historylelang/insert.php">Tambah</a><h5>
 
</div><!-- End Page Title -->

     
        <table border="1" cellpadding="4">
            <tr bgcolor="#49a0da"  class="text">
                <th>Id History</th>
                <th>Id Lelang</th>
                <th>Id Barang</th>
                <th>Id User</th>
    ...
    while($result =mysqli_fetch_array($query)){
        ...
        <tr bgcolor="transparent" class="text1">
            <td><?php echo $result['id_history']?></td>
            <td><?php echo $result['id_lelang']?></td>
            <td><?php echo $result['id_barang']?></td>
            <td><?php echo $result['id_user']?></td>
            <td><?php echo $result['penawaran_harga']?></td>
            <td>
            <button class="button"><a href="historylelang/proses-delete.php?id=<?php echo $result['id_history']?>">Delete</a></button>
            <button class="button"><a href="historylelang/update.php?id=<?php echo $result['id_history']?>">Update</a></button>
            <button class="button"><a href="historylelang/cetak.php?id=<?php echo $result['id_history']?>">Cetak</a></button>
    </td>
