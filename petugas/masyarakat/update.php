...
<body id="page-top">
 ...
 <h5>Update Data</h5>
  ...
  <h5><a href="../masyarakat.php">Kembali</a><h5>
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($koneksi, "SELECT * FROM tb_masyarakat WHERE id_user = '$id'");
    ...
    ?>
                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_user']; ?>">
                    ...
                    <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_user" value="<?php echo $row['id_user']; ?>" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>Nama Lengkap</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="nama_lengkap" value="<?php echo $row['nama_lengkap']; ?>" readonly>
                            </td>
                        </tr>           
                        <tr>
                            <td>Username</td>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="telp" value="<?php echo $row['telp']; ?>">
                            </td>
                        </tr>        
                        <tr>
