  ...
  <h1> Lelang</h1><br>
    ...
    while($result =mysqli_fetch_array($query)){
        ...
        <tr bgcolor="transparent" class="text1">
            ...
            <td><?php echo $result['tgl_lelang']?></td>
            <td><?php echo $result['harga_akhir']?></td>
            <td><?php echo $result['id_user']?></td>
            <td><?php echo $result['id_petugas']?></td>
            <td><?php echo $result['status']?></td>
            <td>
            <button class="button"><a href="lelang/proses-delete.php?id=<?php echo $result['id_lelang']?>">Delete</a></button>
            <button class="button"><a href="lelang/update.php?id=<?php echo $result['id_lelang']?>">Update</a></button>
            <button class="button"><a href="lelang/cetak.php?id=<?php echo $result['id_lelang']?>">Cetak</a></button>
    </td>
