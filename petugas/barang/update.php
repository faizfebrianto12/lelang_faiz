...
<body id="page-top">
 ...
 <h5>Update Data</h5>
  ...
  <h5><a href="../barang.php">Kembali</a><h5>
    ...
    ?>
                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_barang']; ?>">
                    <table border="1" cellpadding="4">
                    <tr>
                            <td>Id Barang</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_barang" value="<?php echo $row['id_barang']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Nama Barang</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="nama_barang" value="<?php echo $row['nama_barang']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Tanggal</td>
                            <td align="center">:</td>
                            <td>
                                <input type="date" class="form-input" name="tgl" value="<?php echo $row['tgl']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Harga Awal</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="harga_awal" value="<?php echo $row['harga_awal']; ?>">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="deskripsi_barang" value="<?php echo $row['deskripsi_barang']; ?>">
                            </td>
                        </tr>
                        <tr>
