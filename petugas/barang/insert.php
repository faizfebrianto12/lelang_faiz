                ...
                <form class="" action="./insert_proses.php" method="post">
                    <table border="1" cellpadding="4">
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_barang">
                            </td>
                        </tr>
                        <tr>
                            <td>Nama Barang</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="nama_barang">
                            </td>
                        </tr>
                        <tr>
                            <td>Tanggal</td>
                            <td align="center">:</td>
                            <td>
                                <input type="date" class="form-input" name="tgl">
                            </td>
                        </tr>
                        <tr>
                            <td>Harga Awal</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="harga_awal">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="deskripsi_barang">
                            </td>
                        </tr>
                        <tr>
