                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col">
                                            <h3>Lelang</h3>
                                             <div class="card text-black"><h4>Total Data : <?=$count1;?></h4></div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col">
                                            <h3>History</h3>
                                             <div class="card text-black"><h4>Total Data : <?=$count2;?></h4></div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col">
                                            <h3>Barang</h3>
                                             <div class="card text-black"><h4>Total Data : <?=$count3;?></h4></div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col">
                                            <h3>Masyarakat</h3>
                                             <div class="card text-black"><h4>Total Data : <?=$count4;?></h4></div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
