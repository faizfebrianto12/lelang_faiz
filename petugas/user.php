          ...
          while ($row = mysqli_fetch_assoc($sql)) {
              ?>
                    <tr>
                        ...
                        <td>
                        <button class="b1"><a href="user/update.php?id=<?php echo $row['id_user'] ?>">Update</a></button>
                        <button class="b2"><a href="user/proses-delete.php?id=<?php echo $row['id_user'] ?>">Delete</a></button>
          </td>
                    </tr>
            </tbody>
            <?php
