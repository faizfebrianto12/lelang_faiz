        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <a id="user" class="nav-link scrolito action">Petugas, <i><?php echo $_SESSION['userweb']; ?></i> !</a>
            ...
            <div class="pagetitle">
  <h1>History Lelang</h1><br>
 <h5>Update Data</h5>

  <h5><a href="../historylelang.php">Kembali</a><h5>
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($koneksi, "SELECT * FROM history_lelang WHERE id_history = '$id'");
    ...
    ?>
                ...
                <input type="hidden" name="id" id="id" value="<?php echo $row['id_history']; ?>">
                    <table border="1" cellpadding="4">
                    <tr>
                            <td>Id History</td>
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_history" value="<?php echo $row['id_history']; ?>">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="penawaran_harga" value="<?php echo $row['penawaran_harga']; ?>">
                            </td>
                        </tr>           
                        <tr>
                            <td>Id Lelang</td>
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_lelang" value="<?php echo $row['id_lelang']; ?>">

<?php
require __DIR__. './koneksi.php';
$sql = mysqli_query($koneksi, "SELECT * FROM tb_lelang");
while ($row = mysqli_fetch_assoc($sql)) {
?>
<option><?php echo $row['id_lelang'] ?></option>
<?php
}
?>
</select>
