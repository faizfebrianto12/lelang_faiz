                ...
                <form class="" action="./insert_proses.php" method="post">
                    <table border="1" cellpadding="4">
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="id_history">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                                <input type="text" class="form-input" name="penawaran_harga">
                            </td>
                        </tr>           
                        <tr>
                            <td>Id Lelang</td>
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_lelang">
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_barang">
...
?>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td>
                            <select class="input" name="id_user">
