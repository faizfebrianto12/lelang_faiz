  ...
  <h1> Masyarakat</h1><br>
    ...
    while($result =mysqli_fetch_array($query)){
        ...
        <tr bgcolor="transparent" class="text1">
            ...
            <td>
            <button class="button"><a href="masyarakat/proses-delete.php?id=<?php echo $result['id_user']?>">Delete</a></button>
            <button class="button"><a href="masyarakat/update.php?id=<?php echo $result['id_user']?>">Update</a></button>
            <button class="button"><a href="masyarakat/cetak.php?id=<?php echo $result['id_user']?>">Cetak</a></button>
    </td>
