...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="pagetitle">
  <h1> Barang</h1><br>
  <h5><a href="barang/insert.php">Tambah</a><h5>
    ...
    while($result =mysqli_fetch_array($query)){
        ...
        <tr bgcolor="transparent" class="text1">
            ...
            <td>
            <button class="button"><a href="barang/proses-delete.php?id=<?php echo $result['id_barang']?>">Delete</a></button>
            <button class="button"><a href="barang/update.php?id=<?php echo $result['id_barang']?>">Update</a></button>
            <button class="button"><a href="barang/cetak.php?id=<?php echo $result['id_barang']?>">Cetak</a></button>
    </td>
