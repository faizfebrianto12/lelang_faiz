            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tentang Lelang</h1>
                    </div>

                   <p color="#fff">Lelang merupakan istilah sebuah transaksi jual beli dengan sistematika khusus. Lelang didefinisikan sebagai penjualan barang yang terbuka untuk umum dengan penawaran harga secara tertulis dan/atau lisan yang semakin meningkat atau menurun untuk mencapai harga tertinggi, yang didahului dengan pengumuman lelang.</p>
